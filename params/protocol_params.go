...
var (
	...
	PessimismBaseFeeRecipient = common.HexToAddress("0x4200000000000000000000000000000000000019")
	// The L1 portion of the transaction fee accumulates at this predeploy
	PessimismL1FeeRecipient = common.HexToAddress("0x420000000000000000000000000000000000001A")
)
